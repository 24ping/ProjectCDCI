...
def mat_tooColumn(
    input_matrix, col_num
):  # this function basically return a specific column from matrix
    column = []
...
def add_Rkey(
    text_matrix, key_matrix
):  # ihave updated the result to be more interpretted to numbers(asci)
    list_of_colomns = {1: [], 2: [], 3: [], 4: []}
    i = 0
    j = 1
    column = []
...
fifth = switch_col(fourth)
# in this function i should implement a modula function that will reduce hige numbers to acceptable numbers
# function is simple
# numbermodulu(128)
print(5)
print(fifth)
